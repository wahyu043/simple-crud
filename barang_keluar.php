                                                                            ...
                                                                            ?>
                                                                                <div class="form-group">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-sm-8"><input type="text" class="form-control" name="id_barang" placeholder="Kode Barang" value="<?php echo $row['kode_barang']; ?>" readonly></div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <div class="row">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-sm-8"><input type="text" class="form-control" name="keterangan" placeholder="Satuan" value="<?php echo $row['satuan']; ?>"></div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <div class="row">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-sm-8"><input type="number" class="form-control" name="stok" placeholder="Jumlah Barang" value="<?php echo $row['jumlah']; ?>"></div>
                                                                                    </div>
                                                                                    <div class="modal-footer">
                                    ...
                                    <div class="modal-body">
                                        <form action="function_masuk.php?act=tambahbarang" method="post" role="form" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <label class="col-sm-3 control-label text-right">Satuan<span class="text-red">*</span></label>
                                                    <div class="col-sm-8"><input type="textarea" class="form-control" name="satuan" placeholder="Keterangan" value="" required></div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="row">
